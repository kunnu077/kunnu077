...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1200&color=00BFFF&center=true&vCenter=true&width=600&lines=Full+Stack+Web+Developer;MERN+Stack+Developer;Backend+Engineer;Open+Source+Contributor;Lifelong+Learner" alt="Typing Animation" />
</p>
...
#### 💬 [DevTinder](https://devtinder-remo.vercel.app/)
> Developer collaboration platform  
- Real-time chat with Socket.io  
- JWT-based authentication  
- CRUD APIs using Express.js and MongoDB 
- Responsive UI using React & Tailwind  

#### 📝 [QuickBlog](https://quick-blog-navy.vercel.app/)
...
#### 🏨 [QuickStay](https://your-quickstay-demo-link.vercel.app/)
> Hotel booking platform with Admin & User panels  
- Role-based authentication (Admin/User)  
- Room booking, management, and filters  
...
- 🎓 **NPTEL Certification in DBMS (2024)**  
- 💻 **CISCO CPA – Programming Essentials in C++ (2023)**  
